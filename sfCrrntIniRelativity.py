...
k_Ah_bq____ = k_Ch_bq____ = k_Vh_bq____ = k_Th_bq____ = 1
k_pQh_bq____ = 0.302824523103951
k_eQh_bq____ = -k_pQh_bq____

## *******************************************************************************
## Heviside-Lorentz no dimentional value for the modified natural system of unites
k_pQhk_bq____= 0.302824523103951
k_Chk_bq____ = k_Ahk_bq____ = k_Vhk_bq____ = k_Thk_bq____ = 1
k_eQhk_bq____ = k_pQhk_bq____

## *******************************************************************************
## Heviside-Lorentz no dimentional value for the SI
(k_Al_bq____, k_Cl_bq____, k_Vl_bq____, k_Tl_bq____, k_pQl_bq____) = (1,
...
def tt():
    ...
    k_Th_bq____ = k_Tn_bq____ / sf.sqrt(k_u0n_bq____)
    ...
    # rot H = 1/c j date:2015/05/15 (金) time:09:03
    k_Al_bq____ = ut.A / sf.sqrt(ut.e0)/336066.81876646896  # date:2015/05/17 (日) time:08:14
    k_Cl_bq____ = ut.C / sf.sqrt(ut.e0)/336066.81876646896
    k_Vl_bq____ = ut.V * sf.sqrt(ut.e0)/2.9755987326285099e-6
    k_Tl_bq____ = ut.T / sf.sqrt(ut.u0)/892.06205807638571
    ...
    # *********************************************************************************
    # **** define modified Natural where the unit charge assigned to elementary charge
    ...
    #print "debug: k_eQhk_bq____:", k_eQhk_bq____
